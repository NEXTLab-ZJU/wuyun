...
class SkeletonEmbedding(nn.Module):
    def __init__(self, event2word_dict, d_embed, padding_idx_list):
        super().__init__()
        ...
        self.token_embed_proj = nn.Linear(len(KEYS) * d_embed, d_embed)

    def forward(self, Tempo, Bar, Position, Token, Duration=None):
...
if __name__ == '__main__':
    ...
    mumidi_embed = SkeletonEmbedding(event2word_dict, hparams.skeleton_model['d_model'], padding_idx_list)
